...
```{r}
fit_dimensions1 <- brm(answer ~ question + (0 + question  | patient), family = cumulative("logit"), data = simple_test_long, refresh = 0, file = paste0(cache_dir, "/dimensions1.rds"))
fit_dimensions1
```
