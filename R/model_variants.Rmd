...
fit_rescor_bgoodri <- brm(bf(mvbind(q1,q2,q3) ~ 1 + time_from_diagnosis, family = empty_cumulative()) + set_rescor(FALSE), data = simple_test, stanvars = sv, adapt_delta = 0.95)
