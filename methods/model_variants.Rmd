...
```{r}
bayesplot::mcmc_pairs(fit_multivariate, regex_pars = c("r_patient__q1.*[1-3]", "b_q1_Intercept"))


bayesplot::mcmc_pairs(fit_multivariate, regex_pars = c("r_patient__q1.*[2]", "b_q1_Intercept.[2-3]"))
...
fit_thres_rescor_augmented <- brm(f, data = simple_test, stanvars = sv_augmented,
                                  file = file.path(cache_dir, "cumulative_thresh_rescor_augmented.rds"), file_refit = "on_change")
